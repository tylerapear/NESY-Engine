...
class Creature:
  def __init__(
    ...
    self._current_animation = animations["Up"]
    print(self._current_animation._current_image_path)
    print(self._current_animation._current_image)
  ...
  def update(self, dt, world_map):
    ...
    if self.health <= 0:
      if not self.dying:
        ...
        if any(r.get("name") == "Death" for r in self.animations):
